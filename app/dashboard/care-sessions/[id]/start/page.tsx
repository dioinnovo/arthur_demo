...
export default function InspectionStartPage() {
  ...
  const loadClaimData = async () => {
    ...
    if (isNewInspection) {
      ...
      const savedData = localStorage.getItem(`inspection-${sessionId}`)
      if (savedData) {
          ...
          <div className="xl:col-span-3 space-y-6">
            ...
            {isLoading && !claimData && (
              <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 p-8 text-center">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-scc-red mx-auto mb-4" />
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 p-6" data-testid="claim-information">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 bg-scc-red/10 rounded-lg">
                      <FileText className="text-scc-red" size={24} />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <span className="font-semibold text-scc-red">{claimData.claimNumber}</span>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2 mt-2">
                            {claimData.incident.damageTypes.map((type) => (
                              <span key={type} className="px-3 py-1 bg-scc-red/10 text-scc-red text-sm rounded-full font-medium">
                                {type}
                              </span>
                            ))}
                          </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 pr-10 text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-scc-red focus:border-scc-red bg-white dark:bg-gray-900 appearance-none cursor-pointer"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-scc-red focus:border-scc-red"
                      />
                    </div>
                    <div>
                        ...
                        <button
                          ...
                          className={`p-4 rounded-lg border transition-all ${
                            inspectionSetup.inspectionFocus.includes(type)
                              ? 'border-scc-red bg-scc-red/10 text-scc-red font-semibold'
                              : 'border-gray-300 hover:border-scc-red/50 hover:bg-gray-50'
                          }`}
                        >
                          {type}
                        </button>
          ...
          <div className="space-y-6">
            ...
            {isLoading ? (
              <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  <Brain className="text-scc-red animate-pulse" size={24} />
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <Brain className="text-scc-red" size={24} />
                ...
                {historicalData.previousClaims.length > 0 && (
                  <div className="mb-6">
                    ...
                    {historicalData.previousClaims.map((claim: any, idx: number) => (
                      <div key={idx} className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg mb-3 border-l-4 border-scc-red">
                        ...
                        <div className="text-scc-red font-semibold mt-1">{claim.status}</div>
                      </div>
                    ))}
                  </div>
                )}
                  ...
                  <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                    {historicalData.neighborhoodPatterns.map((pattern: string, idx: number) => (
                      <li key={idx} className="flex items-start gap-2">
                        <span className="text-scc-red font-bold mt-1">•</span>
                        <span>{pattern}</span>
                      </li>
                    ))}
                  </ul>
            ...
            <button
              ...
              className={`w-full p-4 rounded-xl font-semibold transition-all flex items-center justify-center gap-3 text-lg ${
                isFormValid
                  ? 'bg-scc-red text-white hover:bg-scc-red-dark cursor-pointer shadow-lg shadow-scc-red/25 transform hover:scale-105'
